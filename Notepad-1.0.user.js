...
(function () {
    ...
    function getLastSavedDate() {
        const lastSaved = GM_getValue('notepadLastSaved', null);
    ...
    function saveText(text) {
        ...
        GM_setValue('notepadLastSaved', new Date().toISOString());
    }
    ...
    function updateStatus() {
        ...
        if (status && textArea) {
            ...
            if (lastSaved) {
                const Date = formatDate(lastSaved);
                addTip(status, `Ostatnio zapisano:<br>${Date}`);
            }
        }
    }
